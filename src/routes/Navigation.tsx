...
import PlantillasPersonalizadas from '../pages/PlantillasPersonalizadas';
...
const Navigation = () => {
  ...
  return (
    <>
      <BrowserRouter>
        {show ? (
          <i onClick={handleClick} className="bx bx-menu icons__nav"></i>
        ) : (
          <i
            onClick={handleClick}
            className="bx bx-x icons__nav icons__nav-close"
          ></i>
        )}
        <nav>
          <ul className={`menu ${show ? 'show' : ''}`}>
            <li>
              <NavLink className="items__nav" onClick={handleClick} to="/home">
                Home
              </NavLink>
            </li>
            <li>
              <NavLink
                className="items__nav"
                onClick={handleClick}
                to="/general"
              >
                General
        ...
        <Routes>
          ...
          <Route
            path="PlantillasPersonalizadas"
            element={<PlantillasPersonalizadas />}
          />
